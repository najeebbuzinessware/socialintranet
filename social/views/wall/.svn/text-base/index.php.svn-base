...
<!-- /mfLinks -->
											 					...
											 					<div class="row-fluid feedItem_Content_MainUser" >
											 						<div class="span12" >
											 							<ul class="unstyled" >
											 								...
											 								<li><small class="text_grey" ><?php $posttime = BWDataFunction::humanTiming($val['CreatedOn']); if(strlen($posttime)>0){ echo $posttime; }else{ echo "2 second ago";} ?></small></li>
											 							</ul>
		...
		'options'=>array(
			...
			<?php $this->widget('bootstrap.widgets.TbButton', array(
				...
				'ajaxOptions' => array('success' => 'function(data){ 
					...
					$("#likecount'.$val['WallId'].'").html("("+obj.likecount+")");
		...
		)); ?></a><span id="likecount<?=$val['WallId'] ?>">(<?=BWColFunctions::funcToalUserLike($val['WallId'],'wall') ?>)</span></li>
											 									...
											 									<div class= "cmntusers" >
											 										<table>
											 											<tr>
														 									...
														 									<li class="text_grey" ><i class="icon-time icon-grey" ></i><small><?=BWDataFunction::humanTiming($valcom['CreatedOn']); ?></small></li>
			...
			<?php $this->widget('bootstrap.widgets.TbButton', array(
				...
				'ajaxOptions' => array('success' => 'function(data){ 
					...
					$("#commentlikecount'.$valcom['ComId'].'").html("("+obj.likecount+")");
			...
			<?php $this->widget('bootstrap.widgets.TbButton', array(
				...
				'htmlOptions' => array('class' =>$cmtlikedisplay),
						...
						<span id="commentlikecount<?=$valcom['ComId'] ?>">(<?=BWColFunctions::funcToalUserLike($valcom['ComId'],'wall','comment') ?>)</span></small></li>
														 								</ul>
														 							</td>
											 											</tr>
											 											<tr>
