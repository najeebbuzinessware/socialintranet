...
class ProjectsController extends MemberController
{
	/**
	...
	public function actionCreate()
	{
		...
		$PType = BWDataFunction::TypeData();
		$isActive = BWDataFunction::projectstatusData();

		$this->render('create',array('model'=>$model,'product'=>$productC,'PType'=>$PType,'isActive'=>$isActive));
	}
	...
	public function actionUpdate($id)
	{
		...
		$this->render('update',array(
			'model'=>$model,'product'=>$productC,'PType'=>$PType,'isActive'=>$isActive
		));
	}
