...
class Yiitube extends CWidget {
	...
	protected function youtubeCode()
	{
		return <<<YOUTUBE
		<div id="video_player">
    <a href="{$this->youtubeVideoURL()}" rel="prettyPhoto" title="My YouTube Video">
        <img src="{$this->youtubeImageURL()}" alt="YouTube" height="150" width="150">
    </a>
</div>		
YOUTUBE;
	}
...
VEOH;
	...
	protected function youtubeImageURL()
	{
		//$url = "http://www.youtube.com/embed/{$this->v}?rel=0";
		$url = "http://i3.ytimg.com/vi/{$this->v}/default.jpg"; //http://www.youtube.com/watch?v={$this->v}";
		if ($this->hd)
			$url .= '&amp;hd=1';
		return $url;
	}
