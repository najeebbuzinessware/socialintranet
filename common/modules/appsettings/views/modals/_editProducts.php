...
'htmlOptions' => array('enctype'=>'multipart/form-data'),)); ?>
    ...
    <div class="grid_3">
      ...
      <?php  /*$criteria = new CDbCriteria();
             ...
             echo $form->dropDownList($model,'Gid',CHtml::listData(TblProductGroups::model()->findAll($criteria),"PGId","GroupName"),array('class'=>'headline2 full','prompt'=>'Parent',));
        ?>
    ...
    <div class="halfmargin"></div>
    <div class="specialAction RIGHT">
        <?php echo CHtml::submitButton('Save (Ctrl+S)',array('class'=>'specialAction RIGHT','id'=>'btn_rec_save_button',"name"=>"btnsave")); ?>
    </div>
    <div class="clear"></div>
    </div>
<?php $this->endWidget(); ?>
